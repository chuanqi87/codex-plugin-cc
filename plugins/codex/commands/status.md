---
description: Show active and recent bridge jobs for this repository, including review-gate status
argument-hint: '[job-id] [--backend codex|opencode] [--wait] [--timeout-ms <ms>] [--all]'
